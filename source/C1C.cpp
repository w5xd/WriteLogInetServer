...
SOAP_SOURCE_STAMP("@(#) C1C.cpp ver 2.8.32 2016-05-13 01:07:37 GMT")
...
SOAP_FMAC3 int SOAP_FMAC4 C1_fdelete(struct soap_clist *p)
{	switch (p->type)
	{
	case SOAP_TYPE_C1_std__string:
		if (p->size < 0)
	...
	case SOAP_TYPE_C1_contest2__ArrayOfstring:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__ArrayOfstring*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__ArrayOfstring*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest2__ArrayOfint:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__ArrayOfint*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__ArrayOfint*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest2__Qso:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__Qso*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__Qso*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest2__ArrayOfQso:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__ArrayOfQso*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__ArrayOfQso*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest2__QsoUpdate:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__QsoUpdate*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__QsoUpdate*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest2__QsoIdVersion:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__QsoIdVersion*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__QsoIdVersion*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest2__ArrayOfQsoIdVersion:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__ArrayOfQsoIdVersion*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__ArrayOfQsoIdVersion*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest2__LogSummary:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__LogSummary*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__LogSummary*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest2__RigFrequency:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__RigFrequency*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__RigFrequency*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest2__ArrayOfRigFrequency:
		if (p->size < 0)
			SOAP_DELETE(static_cast<contest2__ArrayOfRigFrequency*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<contest2__ArrayOfRigFrequency*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__GetSessionIdResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__GetSessionIdResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__GetSessionIdResponse*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__GetSessionId:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__GetSessionId*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__GetSessionId*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__AddAndGetLogSummaryResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__AddAndGetLogSummaryResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__AddAndGetLogSummaryResponse*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__AddAndGetLogSummary:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__AddAndGetLogSummary*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__AddAndGetLogSummary*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__addAndGetQsosResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__addAndGetQsosResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__addAndGetQsosResponse*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__addAndGetQsos:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__addAndGetQsos*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__addAndGetQsos*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__getQsosByKeyArrayResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__getQsosByKeyArrayResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__getQsosByKeyArrayResponse*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__getQsosByKeyArray:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__getQsosByKeyArray*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__getQsosByKeyArray*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__ColumnNamesToIndicesResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__ColumnNamesToIndicesResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__ColumnNamesToIndicesResponse*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__ColumnNamesToIndices:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__ColumnNamesToIndices*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__ColumnNamesToIndices*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__ExchangeFrequenciesResponse:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__ExchangeFrequenciesResponse*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__ExchangeFrequenciesResponse*>(p->ptr));
		break;
	case SOAP_TYPE_C1_contest3__ExchangeFrequencies:
		if (p->size < 0)
			SOAP_DELETE(static_cast<struct contest3__ExchangeFrequencies*>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<struct contest3__ExchangeFrequencies*>(p->ptr));
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_C1_SOAP_ENV__Header:
		if (p->size < 0)
	...
	case SOAP_TYPE_C1_std__vectorTemplateOfPointerTocontest2__RigFrequency:
		if (p->size < 0)
			SOAP_DELETE(static_cast<std::vector<contest2__RigFrequency *> *>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<std::vector<contest2__RigFrequency *> *>(p->ptr));
		break;
	case SOAP_TYPE_C1_std__vectorTemplateOfPointerTocontest2__QsoIdVersion:
		if (p->size < 0)
			SOAP_DELETE(static_cast<std::vector<contest2__QsoIdVersion *> *>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<std::vector<contest2__QsoIdVersion *> *>(p->ptr));
		break;
	case SOAP_TYPE_C1_std__vectorTemplateOfPointerTocontest2__Qso:
		if (p->size < 0)
			SOAP_DELETE(static_cast<std::vector<contest2__Qso *> *>(p->ptr));
		else
			SOAP_DELETE_ARRAY(static_cast<std::vector<contest2__Qso *> *>(p->ptr));
		break;
	case SOAP_TYPE_C1_std__vectorTemplateOfint:
		if (p->size < 0)
...
SOAP_FMAC3 void SOAP_FMAC4 C1_finsert(struct soap *soap, int t, int tt, void *p, size_t index, const void *q, void **x)
{
	...
	case SOAP_TYPE_C1_contest2__ArrayOfRigFrequency:
		...
		*(contest2__ArrayOfRigFrequency*)p = *(contest2__ArrayOfRigFrequency*)q;
		break;
	case SOAP_TYPE_C1_contest3__GetSessionIdResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__GetSessionIdResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__GetSessionIdResponse*)p = *(struct contest3__GetSessionIdResponse*)q;
		break;
	case SOAP_TYPE_C1_contest3__GetSessionId:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__GetSessionId type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__GetSessionId*)p = *(struct contest3__GetSessionId*)q;
		break;
	case SOAP_TYPE_C1_contest3__AddAndGetLogSummaryResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__AddAndGetLogSummaryResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__AddAndGetLogSummaryResponse*)p = *(struct contest3__AddAndGetLogSummaryResponse*)q;
		break;
	case SOAP_TYPE_C1_contest3__AddAndGetLogSummary:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__AddAndGetLogSummary type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__AddAndGetLogSummary*)p = *(struct contest3__AddAndGetLogSummary*)q;
		break;
	case SOAP_TYPE_C1_contest3__addAndGetQsosResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__addAndGetQsosResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__addAndGetQsosResponse*)p = *(struct contest3__addAndGetQsosResponse*)q;
		break;
	case SOAP_TYPE_C1_contest3__addAndGetQsos:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__addAndGetQsos type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__addAndGetQsos*)p = *(struct contest3__addAndGetQsos*)q;
		break;
	case SOAP_TYPE_C1_contest3__getQsosByKeyArrayResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__getQsosByKeyArrayResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__getQsosByKeyArrayResponse*)p = *(struct contest3__getQsosByKeyArrayResponse*)q;
		break;
	case SOAP_TYPE_C1_contest3__getQsosByKeyArray:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__getQsosByKeyArray type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__getQsosByKeyArray*)p = *(struct contest3__getQsosByKeyArray*)q;
		break;
	case SOAP_TYPE_C1_contest3__ColumnNamesToIndicesResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__ColumnNamesToIndicesResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__ColumnNamesToIndicesResponse*)p = *(struct contest3__ColumnNamesToIndicesResponse*)q;
		break;
	case SOAP_TYPE_C1_contest3__ColumnNamesToIndices:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__ColumnNamesToIndices type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__ColumnNamesToIndices*)p = *(struct contest3__ColumnNamesToIndices*)q;
		break;
	case SOAP_TYPE_C1_contest3__ExchangeFrequenciesResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__ExchangeFrequenciesResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct contest3__ExchangeFrequenciesResponse*)p = *(struct contest3__ExchangeFrequenciesResponse*)q;
		break;
	case SOAP_TYPE_C1_contest3__ExchangeFrequencies:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct contest3__ExchangeFrequencies type=%d location=%p object=%p\n", t, p, q));
...
SOAP_FMAC1 std::string * SOAP_FMAC2 soap_instantiate_std__string(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	soap_link(soap, p, SOAP_TYPE_C1_std__string, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC1 contest2__ArrayOfRigFrequency * SOAP_FMAC2 soap_instantiate_contest2__ArrayOfRigFrequency(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__ArrayOfRigFrequency);
		if (p)
			((contest2__ArrayOfRigFrequency*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__ArrayOfRigFrequency, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__ArrayOfRigFrequency*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__ArrayOfRigFrequency location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__ArrayOfRigFrequency, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:ArrayOfRigFrequency", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 contest2__RigFrequency * SOAP_FMAC2 soap_instantiate_contest2__RigFrequency(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__RigFrequency);
		if (p)
			((contest2__RigFrequency*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__RigFrequency, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__RigFrequency*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__RigFrequency location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__RigFrequency, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:RigFrequency", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_contest2__LogSummary(struct soap *soap, const char *tag, int id, const contest2__LogSummary *a, const char *type)
{
	...
	{	if (soap_element_nil(soap, "logSummaryIds"))
			return soap->error;
	}
	else
...
SOAP_FMAC1 contest2__LogSummary * SOAP_FMAC2 soap_instantiate_contest2__LogSummary(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__LogSummary);
		if (p)
			((contest2__LogSummary*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__LogSummary, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__LogSummary*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__LogSummary location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__LogSummary, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:LogSummary", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 contest2__ArrayOfQsoIdVersion * SOAP_FMAC2 soap_instantiate_contest2__ArrayOfQsoIdVersion(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__ArrayOfQsoIdVersion);
		if (p)
			((contest2__ArrayOfQsoIdVersion*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__ArrayOfQsoIdVersion, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__ArrayOfQsoIdVersion*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__ArrayOfQsoIdVersion location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__ArrayOfQsoIdVersion, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:ArrayOfQsoIdVersion", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 contest2__QsoIdVersion * SOAP_FMAC2 soap_instantiate_contest2__QsoIdVersion(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__QsoIdVersion);
		if (p)
			((contest2__QsoIdVersion*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__QsoIdVersion, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__QsoIdVersion*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__QsoIdVersion location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__QsoIdVersion, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:QsoIdVersion", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_contest2__QsoUpdate(struct soap *soap, const char *tag, int id, const contest2__QsoUpdate *a, const char *type)
{
	...
	{	if (soap_element_nil(soap, "qsoArray"))
			return soap->error;
	}
	else
...
SOAP_FMAC1 contest2__QsoUpdate * SOAP_FMAC2 soap_instantiate_contest2__QsoUpdate(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__QsoUpdate);
		if (p)
			((contest2__QsoUpdate*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__QsoUpdate, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__QsoUpdate*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__QsoUpdate location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__QsoUpdate, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:QsoUpdate", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 contest2__ArrayOfQso * SOAP_FMAC2 soap_instantiate_contest2__ArrayOfQso(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__ArrayOfQso);
		if (p)
			((contest2__ArrayOfQso*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__ArrayOfQso, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__ArrayOfQso*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__ArrayOfQso location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__ArrayOfQso, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:ArrayOfQso", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_contest2__Qso(struct soap *soap, const char *tag, int id, const contest2__Qso *a, const char *type)
{
	...
	{	if (soap_element_nil(soap, "qsoparts"))
			return soap->error;
	}
	else
...
SOAP_FMAC1 contest2__Qso * SOAP_FMAC2 soap_instantiate_contest2__Qso(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__Qso);
		if (p)
			((contest2__Qso*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__Qso, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__Qso*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__Qso location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__Qso, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:Qso", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 contest2__ArrayOfint * SOAP_FMAC2 soap_instantiate_contest2__ArrayOfint(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__ArrayOfint);
		if (p)
			((contest2__ArrayOfint*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__ArrayOfint, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__ArrayOfint*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__ArrayOfint location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__ArrayOfint, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:ArrayOfint", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 contest2__ArrayOfstring * SOAP_FMAC2 soap_instantiate_contest2__ArrayOfstring(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(contest2__ArrayOfstring);
		if (p)
			((contest2__ArrayOfstring*)p)->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(contest2__ArrayOfstring, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				((contest2__ArrayOfstring*)p)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated contest2__ArrayOfstring location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest2__ArrayOfstring, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (this->soap_out(soap, tag?tag:"contest2:ArrayOfstring", -2, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 struct SOAP_ENV__Fault * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Fault(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	soap_link(soap, p, SOAP_TYPE_C1_SOAP_ENV__Fault, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC1 struct SOAP_ENV__Reason * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Reason(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	soap_link(soap, p, SOAP_TYPE_C1_SOAP_ENV__Reason, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC1 struct SOAP_ENV__Detail * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Detail(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	soap_link(soap, p, SOAP_TYPE_C1_SOAP_ENV__Detail, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC1 struct SOAP_ENV__Code * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Code(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	soap_link(soap, p, SOAP_TYPE_C1_SOAP_ENV__Code, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC1 struct SOAP_ENV__Header * SOAP_FMAC2 soap_instantiate_SOAP_ENV__Header(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	soap_link(soap, p, SOAP_TYPE_C1_SOAP_ENV__Header, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC3 struct contest3__ExchangeFrequencies * SOAP_FMAC4 soap_in_contest3__ExchangeFrequencies(struct soap *soap, const char *tag, struct contest3__ExchangeFrequencies *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__ExchangeFrequencies *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__ExchangeFrequencies, sizeof(struct contest3__ExchangeFrequencies), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__ExchangeFrequencies *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__ExchangeFrequencies, SOAP_TYPE_C1_contest3__ExchangeFrequencies, sizeof(struct contest3__ExchangeFrequencies), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__ExchangeFrequencies(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__ExchangeFrequencies *p;
	size_t k = sizeof(struct contest3__ExchangeFrequencies);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__ExchangeFrequencies);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__ExchangeFrequencies, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__ExchangeFrequencies location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__ExchangeFrequencies, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__ExchangeFrequencies(soap, tag?tag:"contest3:ExchangeFrequencies", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__ExchangeFrequenciesResponse * SOAP_FMAC4 soap_in_contest3__ExchangeFrequenciesResponse(struct soap *soap, const char *tag, struct contest3__ExchangeFrequenciesResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__ExchangeFrequenciesResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__ExchangeFrequenciesResponse, sizeof(struct contest3__ExchangeFrequenciesResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__ExchangeFrequenciesResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__ExchangeFrequenciesResponse, SOAP_TYPE_C1_contest3__ExchangeFrequenciesResponse, sizeof(struct contest3__ExchangeFrequenciesResponse), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__ExchangeFrequenciesResponse(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__ExchangeFrequenciesResponse *p;
	size_t k = sizeof(struct contest3__ExchangeFrequenciesResponse);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__ExchangeFrequenciesResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__ExchangeFrequenciesResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__ExchangeFrequenciesResponse location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__ExchangeFrequenciesResponse, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__ExchangeFrequenciesResponse(soap, tag?tag:"contest3:ExchangeFrequenciesResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__ColumnNamesToIndices * SOAP_FMAC4 soap_in_contest3__ColumnNamesToIndices(struct soap *soap, const char *tag, struct contest3__ColumnNamesToIndices *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__ColumnNamesToIndices *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__ColumnNamesToIndices, sizeof(struct contest3__ColumnNamesToIndices), soap->type, soap->arrayType, C1_instantiate, C1_fbase);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__ColumnNamesToIndices *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__ColumnNamesToIndices, SOAP_TYPE_C1_contest3__ColumnNamesToIndices, sizeof(struct contest3__ColumnNamesToIndices), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__ColumnNamesToIndices(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__ColumnNamesToIndices *p;
	size_t k = sizeof(struct contest3__ColumnNamesToIndices);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__ColumnNamesToIndices);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__ColumnNamesToIndices, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__ColumnNamesToIndices location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__ColumnNamesToIndices, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__ColumnNamesToIndices(soap, tag?tag:"contest3:ColumnNamesToIndices", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__ColumnNamesToIndicesResponse * SOAP_FMAC4 soap_in_contest3__ColumnNamesToIndicesResponse(struct soap *soap, const char *tag, struct contest3__ColumnNamesToIndicesResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__ColumnNamesToIndicesResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__ColumnNamesToIndicesResponse, sizeof(struct contest3__ColumnNamesToIndicesResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__ColumnNamesToIndicesResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__ColumnNamesToIndicesResponse, SOAP_TYPE_C1_contest3__ColumnNamesToIndicesResponse, sizeof(struct contest3__ColumnNamesToIndicesResponse), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__ColumnNamesToIndicesResponse(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__ColumnNamesToIndicesResponse *p;
	size_t k = sizeof(struct contest3__ColumnNamesToIndicesResponse);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__ColumnNamesToIndicesResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__ColumnNamesToIndicesResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__ColumnNamesToIndicesResponse location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__ColumnNamesToIndicesResponse, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__ColumnNamesToIndicesResponse(soap, tag?tag:"contest3:ColumnNamesToIndicesResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__getQsosByKeyArray * SOAP_FMAC4 soap_in_contest3__getQsosByKeyArray(struct soap *soap, const char *tag, struct contest3__getQsosByKeyArray *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__getQsosByKeyArray *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__getQsosByKeyArray, sizeof(struct contest3__getQsosByKeyArray), soap->type, soap->arrayType, C1_instantiate, C1_fbase);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__getQsosByKeyArray *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__getQsosByKeyArray, SOAP_TYPE_C1_contest3__getQsosByKeyArray, sizeof(struct contest3__getQsosByKeyArray), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__getQsosByKeyArray(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__getQsosByKeyArray *p;
	size_t k = sizeof(struct contest3__getQsosByKeyArray);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__getQsosByKeyArray);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__getQsosByKeyArray, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__getQsosByKeyArray location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__getQsosByKeyArray, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__getQsosByKeyArray(soap, tag?tag:"contest3:getQsosByKeyArray", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__getQsosByKeyArrayResponse * SOAP_FMAC4 soap_in_contest3__getQsosByKeyArrayResponse(struct soap *soap, const char *tag, struct contest3__getQsosByKeyArrayResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__getQsosByKeyArrayResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__getQsosByKeyArrayResponse, sizeof(struct contest3__getQsosByKeyArrayResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__getQsosByKeyArrayResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__getQsosByKeyArrayResponse, SOAP_TYPE_C1_contest3__getQsosByKeyArrayResponse, sizeof(struct contest3__getQsosByKeyArrayResponse), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__getQsosByKeyArrayResponse(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__getQsosByKeyArrayResponse *p;
	size_t k = sizeof(struct contest3__getQsosByKeyArrayResponse);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__getQsosByKeyArrayResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__getQsosByKeyArrayResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__getQsosByKeyArrayResponse location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__getQsosByKeyArrayResponse, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__getQsosByKeyArrayResponse(soap, tag?tag:"contest3:getQsosByKeyArrayResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__addAndGetQsos * SOAP_FMAC4 soap_in_contest3__addAndGetQsos(struct soap *soap, const char *tag, struct contest3__addAndGetQsos *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__addAndGetQsos *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__addAndGetQsos, sizeof(struct contest3__addAndGetQsos), soap->type, soap->arrayType, C1_instantiate, C1_fbase);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__addAndGetQsos *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__addAndGetQsos, SOAP_TYPE_C1_contest3__addAndGetQsos, sizeof(struct contest3__addAndGetQsos), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__addAndGetQsos(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__addAndGetQsos *p;
	size_t k = sizeof(struct contest3__addAndGetQsos);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__addAndGetQsos);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__addAndGetQsos, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__addAndGetQsos location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__addAndGetQsos, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__addAndGetQsos(soap, tag?tag:"contest3:addAndGetQsos", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__addAndGetQsosResponse * SOAP_FMAC4 soap_in_contest3__addAndGetQsosResponse(struct soap *soap, const char *tag, struct contest3__addAndGetQsosResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__addAndGetQsosResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__addAndGetQsosResponse, sizeof(struct contest3__addAndGetQsosResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__addAndGetQsosResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__addAndGetQsosResponse, SOAP_TYPE_C1_contest3__addAndGetQsosResponse, sizeof(struct contest3__addAndGetQsosResponse), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__addAndGetQsosResponse(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__addAndGetQsosResponse *p;
	size_t k = sizeof(struct contest3__addAndGetQsosResponse);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__addAndGetQsosResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__addAndGetQsosResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__addAndGetQsosResponse location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__addAndGetQsosResponse, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__addAndGetQsosResponse(soap, tag?tag:"contest3:addAndGetQsosResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__AddAndGetLogSummary * SOAP_FMAC4 soap_in_contest3__AddAndGetLogSummary(struct soap *soap, const char *tag, struct contest3__AddAndGetLogSummary *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__AddAndGetLogSummary *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__AddAndGetLogSummary, sizeof(struct contest3__AddAndGetLogSummary), soap->type, soap->arrayType, C1_instantiate, C1_fbase);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__AddAndGetLogSummary *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__AddAndGetLogSummary, SOAP_TYPE_C1_contest3__AddAndGetLogSummary, sizeof(struct contest3__AddAndGetLogSummary), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__AddAndGetLogSummary(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__AddAndGetLogSummary *p;
	size_t k = sizeof(struct contest3__AddAndGetLogSummary);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__AddAndGetLogSummary);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__AddAndGetLogSummary, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__AddAndGetLogSummary location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__AddAndGetLogSummary, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__AddAndGetLogSummary(soap, tag?tag:"contest3:AddAndGetLogSummary", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__AddAndGetLogSummaryResponse * SOAP_FMAC4 soap_in_contest3__AddAndGetLogSummaryResponse(struct soap *soap, const char *tag, struct contest3__AddAndGetLogSummaryResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__AddAndGetLogSummaryResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__AddAndGetLogSummaryResponse, sizeof(struct contest3__AddAndGetLogSummaryResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__AddAndGetLogSummaryResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__AddAndGetLogSummaryResponse, SOAP_TYPE_C1_contest3__AddAndGetLogSummaryResponse, sizeof(struct contest3__AddAndGetLogSummaryResponse), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__AddAndGetLogSummaryResponse(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__AddAndGetLogSummaryResponse *p;
	size_t k = sizeof(struct contest3__AddAndGetLogSummaryResponse);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__AddAndGetLogSummaryResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__AddAndGetLogSummaryResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__AddAndGetLogSummaryResponse location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__AddAndGetLogSummaryResponse, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__AddAndGetLogSummaryResponse(soap, tag?tag:"contest3:AddAndGetLogSummaryResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__GetSessionId * SOAP_FMAC4 soap_in_contest3__GetSessionId(struct soap *soap, const char *tag, struct contest3__GetSessionId *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__GetSessionId *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__GetSessionId, sizeof(struct contest3__GetSessionId), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__GetSessionId *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__GetSessionId, SOAP_TYPE_C1_contest3__GetSessionId, sizeof(struct contest3__GetSessionId), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__GetSessionId(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__GetSessionId *p;
	size_t k = sizeof(struct contest3__GetSessionId);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__GetSessionId);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__GetSessionId, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__GetSessionId location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__GetSessionId, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__GetSessionId(soap, tag?tag:"contest3:GetSessionId", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct contest3__GetSessionIdResponse * SOAP_FMAC4 soap_in_contest3__GetSessionIdResponse(struct soap *soap, const char *tag, struct contest3__GetSessionIdResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct contest3__GetSessionIdResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_C1_contest3__GetSessionIdResponse, sizeof(struct contest3__GetSessionIdResponse), soap->type, soap->arrayType, C1_instantiate, C1_fbase);
	if (!a)
		return NULL;
	...
	{	a = (struct contest3__GetSessionIdResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_C1_contest3__GetSessionIdResponse, SOAP_TYPE_C1_contest3__GetSessionIdResponse, sizeof(struct contest3__GetSessionIdResponse), 0, C1_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_contest3__GetSessionIdResponse(%p, %d, %s, %s)\n", soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct contest3__GetSessionIdResponse *p;
	size_t k = sizeof(struct contest3__GetSessionIdResponse);
	if (n < 0)
	{	p = SOAP_NEW(struct contest3__GetSessionIdResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(struct contest3__GetSessionIdResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct contest3__GetSessionIdResponse location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_contest3__GetSessionIdResponse, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
{
	if (soap_out_contest3__GetSessionIdResponse(soap, tag?tag:"contest3:GetSessionIdResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize__QName(struct soap *soap, char *const*a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_reference(soap, *a, SOAP_TYPE_C1__QName);
#endif
}
...
SOAP_FMAC3 std::vector<contest2__RigFrequency *> * SOAP_FMAC4 soap_in_std__vectorTemplateOfPointerTocontest2__RigFrequency(struct soap *soap, const char *tag, std::vector<contest2__RigFrequency *> *a, const char *type)
{
	...
	for (soap_flag = 0;; soap_flag = 1)
	{
		...
		{	if (!soap_id_forward(soap, *soap->id?soap->id:soap->href, a, (size_t)a->size(), SOAP_TYPE_C1_contest2__RigFrequency, SOAP_TYPE_C1_std__vectorTemplateOfPointerTocontest2__RigFrequency, sizeof(contest2__RigFrequency), 1, C1_finsert, C1_fbase))
				break;
...
SOAP_FMAC1 std::vector<contest2__RigFrequency *>  * SOAP_FMAC2 soap_instantiate_std__vectorTemplateOfPointerTocontest2__RigFrequency(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(std::vector<contest2__RigFrequency *> );
	}
	else
	{	p = SOAP_NEW_ARRAY(std::vector<contest2__RigFrequency *> , n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated std::vector<contest2__RigFrequency *>  location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_std__vectorTemplateOfPointerTocontest2__RigFrequency, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC3 std::vector<contest2__QsoIdVersion *> * SOAP_FMAC4 soap_in_std__vectorTemplateOfPointerTocontest2__QsoIdVersion(struct soap *soap, const char *tag, std::vector<contest2__QsoIdVersion *> *a, const char *type)
{
	...
	for (soap_flag = 0;; soap_flag = 1)
	{
		...
		n = NULL;
		if (tag && *tag != '-' && (*soap->id || *soap->href))
		{	if (!soap_id_forward(soap, *soap->id?soap->id:soap->href, a, (size_t)a->size(), SOAP_TYPE_C1_contest2__QsoIdVersion, SOAP_TYPE_C1_std__vectorTemplateOfPointerTocontest2__QsoIdVersion, sizeof(contest2__QsoIdVersion), 1, C1_finsert, C1_fbase))
				break;
...
SOAP_FMAC1 std::vector<contest2__QsoIdVersion *>  * SOAP_FMAC2 soap_instantiate_std__vectorTemplateOfPointerTocontest2__QsoIdVersion(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(std::vector<contest2__QsoIdVersion *> );
	}
	else
	{	p = SOAP_NEW_ARRAY(std::vector<contest2__QsoIdVersion *> , n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated std::vector<contest2__QsoIdVersion *>  location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_std__vectorTemplateOfPointerTocontest2__QsoIdVersion, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC3 std::vector<contest2__Qso *> * SOAP_FMAC4 soap_in_std__vectorTemplateOfPointerTocontest2__Qso(struct soap *soap, const char *tag, std::vector<contest2__Qso *> *a, const char *type)
{
	...
	for (soap_flag = 0;; soap_flag = 1)
	{
		...
		n = NULL;
		if (tag && *tag != '-' && (*soap->id || *soap->href))
		{	if (!soap_id_forward(soap, *soap->id?soap->id:soap->href, a, (size_t)a->size(), SOAP_TYPE_C1_contest2__Qso, SOAP_TYPE_C1_std__vectorTemplateOfPointerTocontest2__Qso, sizeof(contest2__Qso), 1, C1_finsert, C1_fbase))
				break;
...
SOAP_FMAC1 std::vector<contest2__Qso *>  * SOAP_FMAC2 soap_instantiate_std__vectorTemplateOfPointerTocontest2__Qso(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (n < 0)
	{	p = SOAP_NEW(std::vector<contest2__Qso *> );
	}
	else
	{	p = SOAP_NEW_ARRAY(std::vector<contest2__Qso *> , n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated std::vector<contest2__Qso *>  location=%p n=%d\n", p, n));
	soap_link(soap, p, SOAP_TYPE_C1_std__vectorTemplateOfPointerTocontest2__Qso, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC3 std::vector<int> * SOAP_FMAC4 soap_in_std__vectorTemplateOfint(struct soap *soap, const char *tag, std::vector<int> *a, const char *type)
{
	...
	for (soap_flag = 0;; soap_flag = 1)
	{
		...
		if (tag && *tag != '-' && (*soap->id || *soap->href))
		{	if (!soap_id_forward(soap, *soap->id?soap->id:soap->href, a, (size_t)a->size(), SOAP_TYPE_C1_int, SOAP_TYPE_C1_std__vectorTemplateOfint, sizeof(int), 0, C1_finsert, C1_fbase))
				break;
...
SOAP_FMAC1 std::vector<int>  * SOAP_FMAC2 soap_instantiate_std__vectorTemplateOfint(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	soap_link(soap, p, SOAP_TYPE_C1_std__vectorTemplateOfint, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
...
SOAP_FMAC3 std::vector<std::string> * SOAP_FMAC4 soap_in_std__vectorTemplateOfstd__string(struct soap *soap, const char *tag, std::vector<std::string> *a, const char *type)
{
	...
	for (soap_flag = 0;; soap_flag = 1)
	{
		...
		if (tag && *tag != '-' && (*soap->id || *soap->href))
		{	if (!soap_id_forward(soap, *soap->id?soap->id:soap->href, a, (size_t)a->size(), SOAP_TYPE_C1_std__string, SOAP_TYPE_C1_std__vectorTemplateOfstd__string, sizeof(std::string), 0, C1_finsert, C1_fbase))
				break;
...
SOAP_FMAC1 std::vector<std::string>  * SOAP_FMAC2 soap_instantiate_std__vectorTemplateOfstd__string(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	soap_link(soap, p, SOAP_TYPE_C1_std__vectorTemplateOfstd__string, n, C1_fdelete);
	if (size)
		*size = k;
	return p;
}
